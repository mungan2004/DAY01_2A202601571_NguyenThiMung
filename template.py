...
def run_assistant(
    ...
    while True:
        ...
        # approximate prompt by combining persona and all history and user_msg
        prompt_text = persona + "".join([m["content"] for m in messages[1:]])
        
        cost_stats = estimate_cost(prompt_text, reply, OPENAI_MODEL)
